    ...
    const handleUpdate = async () => {
        ...
        try {
            ...
            await jobRef.update({
                ...
                estimatedTime: estimatedTime || "Not specified", // ให้ค่า "Not specified" หากไม่มีข้อมูล
                progressDescription: progressDescription || "", // ค่า progressDescription หรือว่าง
                resolutionNotes: resolutionNotes || "", // ค่า resolutionNotes หรือว่าง
                lastUpdated: firebase.firestore.FieldValue.serverTimestamp(),
            });

            // รีเฟรชข้อมูลของ selectedJob หลังบันทึก11ๅๅ111111
        ...
        return (
            <TouchableOpacity onPress={() => openModal(item)} style={styles.jobCard}>
                ...
                <Text style={styles.jobDetails}>
                    <Text style={styles.fontBold}>Due Date:</Text> {item.dueDate ? item.dueDate.toLocaleString() : 'No due date'}
                </Text>
                <Text style={styles.jobDetails}><Text style={styles.fontBold}>Progress:</Text> {item.progress || 0}%</Text>
            </TouchableOpacity>
        );
